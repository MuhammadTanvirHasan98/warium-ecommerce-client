...
const EcommerceLayout = () => {
  ...
  const fetchCoupons = async () => {
    try {
      const res = await fetch(
        "https://warium-ecommerce-server-api.onrender.com/coupons/approved"
      );
  ...
  const newArrivals = [
    {
      title: "Relaxed Short Full Sleep",
      category: "Clothes",
      price: 45,
      oldPrice: 120,
    },
    ...
    {
      title: "Black Floral Wrap Midi",
      category: "Clothes",
      price: 76,
      oldPrice: 25,
    },
    {
      title: "Pure Garment Dyed Coat",
  ...
  const topRated = [
    {
      title: "Pocket Watch Leather Band",
      category: "Watches",
      price: 50,
      oldPrice: 34,
    },
                ...
                <div className="mt-2 sm:mt-0">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold ${
                      coupon.isActive && coupon.isApproved
        ...
        <div className="mt-0 flex flex-col items-start gap-6 px-4 lg:px-0">
          ...
          <div className="text-left max-w-2xl ">
            ...
            <p className="text-gray-600 text-base md:text-lg mb-3">
              Create your unique style using our AI-powered 3D customization
              tool.
            </p>
            <a
              href="#"
